...
```
app/                 # Expo Router routes (keep minimal, delegate to components/scenes)
components/
  elements/          # Reusable UI components (Button, Image, etc.)
  layouts/           # Layout-specific components (headers, navigation)
  chat/              # Chat screen components (MessageBubble, ChatInput, etc.)
  nodes/             # Node discovery components
